...
import com.example.myfinal_project.model.CountryModel;
import com.example.myfinal_project.model.MyCustomAdapter;
...
public class ListOfCountry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.title3_name);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(getApplicationContext(), DetalesActivity.class)
    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            myCustomAdapter = new MyCustomAdapter(ListOfCountry.this, countryModelsList);
            ...
            public void onErrorResponse(VolleyError error) {
                simpleArcLoader.stop();
                simpleArcLoader.setVisibility(View.GONE);
                Toast.makeText(ListOfCountry.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
